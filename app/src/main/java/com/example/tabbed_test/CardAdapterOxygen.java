...
public class CardAdapterOxygen extends RecyclerView.Adapter<MyViewHolder> {
    Context mContext;                          // refactor c -> mContext
    ArrayList<Record> recordList;          // refactor records -> recordList

    public CardAdapterOxygen(Context mContext, ArrayList<Record> records) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.mEntry.setText(recordList.get(position).getOxygen());
